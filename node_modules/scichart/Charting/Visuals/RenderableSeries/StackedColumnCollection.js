        ...
        if (this.canDraw) {
            ...
            Object.keys(seriesGroups_1).forEach(function (key, groupIndex) {
                ...
                seriesArray.forEach(function (el, seriesIndex) {
                    ...
                    var spacing = 0;
                    drawColumns(_this.webAssemblyContext, renderContext, xCoordinateCalculator_1, yCoordinateCalculator_1, isVerticalChart_1, _this.nativeDrawingProvider, xValues_1, bottomVector, topVector, el.getFillBrush(), el.getStrokePen(), viewRect_1, columnWidth_1, spacing, stackedColumnsCount_1, groupIndex);
                    previousEl = el;
                });
            });
        }
